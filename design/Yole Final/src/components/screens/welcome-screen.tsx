  ...
  return (
    <div className={`min-h-screen ${
      ...
      <div className="relative z-10 min-h-full flex flex-col px-6 py-8">
        ...
        <motion.div 
          className="flex-1 flex items-center justify-center pt-16 pb-16"
        ...
        >
          <div className="relative">
            <ImageWithFallback 
              src="https://images.unsplash.com/photo-1655720360377-b97f6715e1ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwbW9iaWxlJTIwbW9uZXklMjB0cmFuc2FjdGlvbiUyMHBob25lJTIwc2VuZGluZ3xlbnwxfHx8fDE3NTc1ODY0ODZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt="African users using mobile money services"
              className="w-56 h-56 sm:w-64 sm:h-64 object-cover rounded-3xl shadow-2xl"
            />
        ...
        {/* Bottom Section - CTA */}
        <motion.div 
          className="pb-8 space-y-6 max-w-sm mx-auto w-full"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.6 }}
        >
          <GradientButton 
            className="w-full h-12 touch-target shadow-lg hover:shadow-xl"
          ...
          <div className="text-center pt-2">
            ...
            <button
              ...
              className={`text-sm font-medium transition-colors touch-target ${
                isDark 
