...
import '../../ui/effects/sparkle_layer.dart';
import '../../core/analytics/analytics_service.dart';

/// Welcome/Onboarding screen with Hero image, headline/subhead from tokens,
/// CTA, and SparkleLayer behind content with micro-interactions.
class WelcomeScreen extends StatefulWidget {
  /// Whether to enable sparkle animations (disabled for testing)
  final bool enableSparkles;

  const WelcomeScreen({super.key, this.enableSparkles = true});
