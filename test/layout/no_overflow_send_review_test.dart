/// Tests to prevent RenderFlex overflow regressions in Send Review screen
///
/// Ensures the screen handles small screens, large text scales, and keyboard
/// without causing layout overflows.
library;
...
void main() {
  group('Send Review Screen - No Overflow Tests', () {
    ...
    testWidgets('No overflow with keyboard open', (tester) async {
      // Provider overrides
      final overrides = <Override>[
        fxRepoProvider.overrideWithValue(mockFxRepo),
        feesRepoProvider.overrideWithValue(mockFeesRepo),
    ...
    testWidgets('No overflow on very small screen', (tester) async {
      // Provider overrides
      final overrides = <Override>[
        fxRepoProvider.overrideWithValue(mockFxRepo),
        feesRepoProvider.overrideWithValue(mockFeesRepo),
    ...
    testWidgets('Bottom CTA remains accessible with keyboard', (tester) async {
      // Provider overrides
      final overrides = <Override>[
        fxRepoProvider.overrideWithValue(mockFxRepo),
        feesRepoProvider.overrideWithValue(mockFeesRepo),
      ...
      // Try to find and tap the continue button (if it exists)
      final continueButton = find.text('Continue to Authentication');
